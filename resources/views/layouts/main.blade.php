...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center" style="margin-left:500px">
    ...
    @yield('content')
    <footer class="border border-t border-gray-800 center" style="text-align:center">
        <div class="container mx-auto text-sm px-4 py-6">
            Powered by <a href="#" class="underline hover:text-gray-300 center">devlopertech</a>
        </div>
    </footer>
    @livewireScripts
</body>
